  ...
  <div class="content-page">
    <div class="content-nav">
      <el-breadcrumb class="breadcrumb" separator="/">
        <el-breadcrumb-item :to="{ name: 'goods' }">数据管理</el-breadcrumb-item>
        <el-breadcrumb-item>{{ infoForm.id ? '编辑数据' : '添加数据' }}</el-breadcrumb-item>
      </el-breadcrumb>
    ...
    <div class="content-main">
      <div class="form-table-box">
        <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
          ...
          <el-form-item label="添加图片" prop="list_pic_url" v-if="!infoForm.list_pic_url">
            <el-upload
              name="file"
              class="upload-demo"
              :action="qiniuZone"
          ...
          <el-form-item label="型号和参数">
            ...
            <div class="spec-wrap">
              <el-table :data="specData" stripe style="width: 100%">
                <el-table-column prop="goods_sn" label="单位数量" width="140">
          ...
          <el-form-item>
            ...
            <el-button type="danger" class="float-right" @click="onCopyGood">复制</el-button>
